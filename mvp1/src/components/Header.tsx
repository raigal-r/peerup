    ...
    return(
        <section>
            <main className="bg-[#0097b3]">
                <div className="container-fluid min-h-[10px] flex flex-grow justify-around bg-[#0097b3] border-opacity-20 border-solid border-2 border-gray-100 rounded-xl pr-5 pl-5">
